...
func SourcesDataSourceSchema(ctx context.Context) schema.Schema {
	paramsSchema := source.ParametersModel{}.TerraformSchema()
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"filter": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"tags": schema.ListNestedAttribute{
						Description: "List of tags to filter sources by",
						Optional:    true,
			...
			"results": schema.ListNestedAttribute{
				...
				Computed:    true,
				// TODO: deduplicate with schema used in the resource?
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
						...
						"schedule": schema.StringAttribute{
							Description: "Schedule information for this source, in cron format.",
							Computed:    true,
						},
...
func (m FilterModel) ToDto(ctx context.Context) (sifflet.PublicSourceFilterDto, diag.Diagnostics) {
	...
	var tags []source.TagModel
	diags = m.Tags.ElementsAs(ctx, &tags, false)
	if diags.HasError() {
		return sifflet.PublicSourceFilterDto{}, diags
	}

	tagsDto, diags := tagsModelToDto(tags)
	if diags.HasError() {
		return sifflet.PublicSourceFilterDto{}, diags
	}
