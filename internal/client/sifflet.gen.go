...
const (
	...
	PublicAthenaParametersDtoTypeUNKNOWN     PublicAthenaParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicBigQueryParametersDtoTypeUNKNOWN     PublicBigQueryParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicDatabricksParametersDtoTypeUNKNOWN     PublicDatabricksParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicDbtCloudParametersDtoTypeUNKNOWN     PublicDbtCloudParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicDbtParametersDtoTypeUNKNOWN     PublicDbtParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicLookerParametersDtoTypeUNKNOWN     PublicLookerParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicMssqlParametersDtoTypeUNKNOWN     PublicMssqlParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicMysqlParametersDtoTypeUNKNOWN     PublicMysqlParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicOracleParametersDtoTypeUNKNOWN     PublicOracleParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicPostgresqlParametersDtoTypeUNKNOWN     PublicPostgresqlParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicPowerBiParametersDtoTypeUNKNOWN     PublicPowerBiParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicQuicksightParametersDtoTypeUNKNOWN     PublicQuicksightParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicRedshiftParametersDtoTypeUNKNOWN     PublicRedshiftParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicSnowflakeParametersDtoTypeUNKNOWN     PublicSnowflakeParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicSourceFilterDtoTypesUNKNOWN     PublicSourceFilterDtoTypes = "_UNKNOWN_"
)
...
const (
	...
	PublicSourceParametersDtoTypeUNKNOWN     PublicSourceParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicSynapseParametersDtoTypeUNKNOWN     PublicSynapseParametersDtoType = "_UNKNOWN_"
)
...
const (
	...
	PublicTableauParametersDtoTypeUNKNOWN     PublicTableauParametersDtoType = "_UNKNOWN_"
)
...
type ServerInterface interface {
	// Sync a workspace
	// (POST /v1/assets/sync)
	PublicSyncAssets(ctx echo.Context, params PublicSyncAssetsParams) error
	// Delete workspace by name
	// (DELETE /v1/assets/{name})
	PublicDeleteWorkspace(ctx echo.Context, name string, params PublicDeleteWorkspaceParams) error
	// Get list of calendars
	// (GET /v1/calendars)
	PublicGetCalendars(ctx echo.Context) error
	// Create a calendar
	// (POST /v1/calendars)
	PublicCreateCalendar(ctx echo.Context) error
	// Delete a calendar
	// (DELETE /v1/calendars/{id})
	PublicDeleteCalendar(ctx echo.Context, id openapi_types.UUID) error
	// Get a calendar by id
	// (GET /v1/calendars/{id})
	PublicGetCalendar(ctx echo.Context, id openapi_types.UUID) error
	// Update a calendar
	// (PATCH /v1/calendars/{id})
	PublicUpdateCalendar(ctx echo.Context, id openapi_types.UUID) error
	// Get list of credentials
	// (GET /v1/credentials)
	PublicGetCredentials(ctx echo.Context) error
	// Create a credential
	// (POST /v1/credentials)
	PublicCreateCredential(ctx echo.Context) error
	// Delete a credential
	// (DELETE /v1/credentials/{name})
	PublicDeleteCredential(ctx echo.Context, name string) error
	// Get a credential by name
	// (GET /v1/credentials/{name})
	PublicGetCredential(ctx echo.Context, name string) error
	// Update a credential
	// (PATCH /v1/credentials/{name})
	PublicUpdateCredential(ctx echo.Context, name string) error
	// Create declarative pipeline lineage
	// (POST /v1/lineages/_create)
	CreatePipelineDeclarativeLineage(ctx echo.Context) error
	// Remove declarative pipeline lineage
	// (POST /v1/lineages/_remove)
	RemovePipelineDeclarativeLineage(ctx echo.Context) error
	// Submit dbt metadata files and trigger the related datasource refresh
	// (POST /v1/metadata/dbt/{projectName}/{target})
	UploadDbtMetadataFiles(ctx echo.Context, projectName string, target string) error
	// Get all Sifflet rules
	// (GET /v1/rules)
	GetAllRule(ctx echo.Context, params GetAllRuleParams) error
	// Trigger a run of the given Sifflet rule id
	// (POST /v1/rules/{id}/_run)
	SiffletRuleManualRun(ctx echo.Context, id openapi_types.UUID) error
	// Get Sifflet rule details by rule id
	// (GET /v1/rules/{id}/details)
	GetSiffletRuleDetails(ctx echo.Context, id openapi_types.UUID) error
	// Get Sifflet rule information by rule id
	// (GET /v1/rules/{id}/info)
	GetSiffletRuleInfo(ctx echo.Context, id openapi_types.UUID) error
	// Get Sifflet rule overview by rule id
	// (GET /v1/rules/{id}/overview)
	GetSiffletRuleOverview(ctx echo.Context, id openapi_types.UUID) error
	// Get all Sifflet rule runs by rule id
	// (GET /v1/rules/{id}/runs)
	GetSiffletRuleRuns(ctx echo.Context, id openapi_types.UUID, params GetSiffletRuleRunsParams) error
	// Get a Sifflet rule run by rule id and run id
	// (GET /v1/rules/{id}/runs/{runId})
	GetSiffletRuleRun(ctx echo.Context, id openapi_types.UUID, runId openapi_types.UUID, params GetSiffletRuleRunParams) error
	// Create a source
	// (POST /v1/sources)
	PublicCreateSource(ctx echo.Context) error
	// Get search results for sources
	// (POST /v1/sources/search)
	PublicGetSources(ctx echo.Context) error
	// Test connection with given source params
	// (POST /v1/sources/test-connection)
	TestSourceConnection(ctx echo.Context) error
	// Delete a source by id
	// (DELETE /v1/sources/{id})
	PublicDeleteSourceById(ctx echo.Context, id openapi_types.UUID) error
	// Get a source by id
	// (GET /v1/sources/{id})
	PublicGetSource(ctx echo.Context, id openapi_types.UUID) error
	// Edit a source
	// (PATCH /v1/sources/{id})
	PublicEditSource(ctx echo.Context, id openapi_types.UUID) error
	// Manually trigger a source metadata ingestion job
	// (POST /v1/sources/{id}/run)
	PublicSourceIngestionManualRun(ctx echo.Context, id openapi_types.UUID) error
	// Get list of users
	// (GET /v1/users)
	PublicGetUsers(ctx echo.Context, params PublicGetUsersParams) error
	// Create a user
	// (POST /v1/users)
	PublicCreateUser(ctx echo.Context) error
	// Delete a user
	// (DELETE /v1/users/{id})
	PublicDeleteUser(ctx echo.Context, id openapi_types.UUID) error
	// Get a user by id
	// (GET /v1/users/{id})
	PublicGetUser(ctx echo.Context, id openapi_types.UUID) error
	// Update a user
	// (PATCH /v1/users/{id})
	PublicUpdateUser(ctx echo.Context, id openapi_types.UUID) error
	// Reset a user password
	// (POST /v1/users/{id}/reset-password)
	PublicResetUserPassword(ctx echo.Context, id openapi_types.UUID) error
}
...
// PublicSyncAssets converts echo context to params.
func (w *ServerInterfaceWrapper) PublicSyncAssets(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Parameter object where we will unmarshal all parameters from the context
	var params PublicSyncAssetsParams
	...
	err = w.Handler.PublicSyncAssets(ctx, params)
	return err
}

// PublicDeleteWorkspace converts echo context to params.
func (w *ServerInterfaceWrapper) PublicDeleteWorkspace(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "name" -------------
	var name string
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params PublicDeleteWorkspaceParams
	// ------------- Optional query parameter "dryRun" -------------
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicDeleteWorkspace(ctx, name, params)
	return err
}

// PublicGetCalendars converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetCalendars(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetCalendars(ctx)
	return err
}

// PublicCreateCalendar converts echo context to params.
func (w *ServerInterfaceWrapper) PublicCreateCalendar(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicCreateCalendar(ctx)
	return err
}

// PublicDeleteCalendar converts echo context to params.
func (w *ServerInterfaceWrapper) PublicDeleteCalendar(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicDeleteCalendar(ctx, id)
	return err
}

// PublicGetCalendar converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetCalendar(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetCalendar(ctx, id)
	return err
}

// PublicUpdateCalendar converts echo context to params.
func (w *ServerInterfaceWrapper) PublicUpdateCalendar(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicUpdateCalendar(ctx, id)
	return err
}

// PublicGetCredentials converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetCredentials(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetCredentials(ctx)
	return err
}

// PublicCreateCredential converts echo context to params.
func (w *ServerInterfaceWrapper) PublicCreateCredential(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicCreateCredential(ctx)
	return err
}

// PublicDeleteCredential converts echo context to params.
func (w *ServerInterfaceWrapper) PublicDeleteCredential(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "name" -------------
	var name string
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicDeleteCredential(ctx, name)
	return err
}

// PublicGetCredential converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetCredential(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "name" -------------
	var name string
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetCredential(ctx, name)
	return err
}

// PublicUpdateCredential converts echo context to params.
func (w *ServerInterfaceWrapper) PublicUpdateCredential(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "name" -------------
	var name string
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicUpdateCredential(ctx, name)
	return err
}

// CreatePipelineDeclarativeLineage converts echo context to params.
func (w *ServerInterfaceWrapper) CreatePipelineDeclarativeLineage(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.CreatePipelineDeclarativeLineage(ctx)
	return err
}

// RemovePipelineDeclarativeLineage converts echo context to params.
func (w *ServerInterfaceWrapper) RemovePipelineDeclarativeLineage(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.RemovePipelineDeclarativeLineage(ctx)
	return err
}

// UploadDbtMetadataFiles converts echo context to params.
func (w *ServerInterfaceWrapper) UploadDbtMetadataFiles(ctx echo.Context) error {
	var err error
	...
	err = runtime.BindStyledParameterWithOptions("simple", "target", ctx.Param("target"), &target, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.UploadDbtMetadataFiles(ctx, projectName, target)
	return err
}

// GetAllRule converts echo context to params.
func (w *ServerInterfaceWrapper) GetAllRule(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Parameter object where we will unmarshal all parameters from the context
	var params GetAllRuleParams
	...
	// ------------- Optional query parameter "ruleTemplateName" -------------

	err = runtime.BindQueryParameter("form", true, false, "ruleTemplateName", ctx.QueryParams(), &params.RuleTemplateName)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter ruleTemplateName: %s", err))
	}

	// ------------- Optional query parameter "lastRunStatus" -------------

	err = runtime.BindQueryParameter("form", true, false, "lastRunStatus", ctx.QueryParams(), &params.LastRunStatus)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter lastRunStatus: %s", err))
	}
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetAllRule(ctx, params)
	return err
}

// SiffletRuleManualRun converts echo context to params.
func (w *ServerInterfaceWrapper) SiffletRuleManualRun(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.SiffletRuleManualRun(ctx, id)
	return err
}

// GetSiffletRuleDetails converts echo context to params.
func (w *ServerInterfaceWrapper) GetSiffletRuleDetails(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetSiffletRuleDetails(ctx, id)
	return err
}

// GetSiffletRuleInfo converts echo context to params.
func (w *ServerInterfaceWrapper) GetSiffletRuleInfo(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetSiffletRuleInfo(ctx, id)
	return err
}

// GetSiffletRuleOverview converts echo context to params.
func (w *ServerInterfaceWrapper) GetSiffletRuleOverview(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetSiffletRuleOverview(ctx, id)
	return err
}

// GetSiffletRuleRuns converts echo context to params.
func (w *ServerInterfaceWrapper) GetSiffletRuleRuns(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetSiffletRuleRunsParams
	// ------------- Optional query parameter "page" -------------
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetSiffletRuleRuns(ctx, id, params)
	return err
}

// GetSiffletRuleRun converts echo context to params.
func (w *ServerInterfaceWrapper) GetSiffletRuleRun(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	err = runtime.BindStyledParameterWithOptions("simple", "runId", ctx.Param("runId"), &runId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetSiffletRuleRunParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetSiffletRuleRun(ctx, id, runId, params)
	return err
}

// PublicCreateSource converts echo context to params.
func (w *ServerInterfaceWrapper) PublicCreateSource(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicCreateSource(ctx)
	return err
}

// PublicGetSources converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetSources(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetSources(ctx)
	return err
}

// TestSourceConnection converts echo context to params.
func (w *ServerInterfaceWrapper) TestSourceConnection(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.TestSourceConnection(ctx)
	return err
}

// PublicDeleteSourceById converts echo context to params.
func (w *ServerInterfaceWrapper) PublicDeleteSourceById(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicDeleteSourceById(ctx, id)
	return err
}

// PublicGetSource converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetSource(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetSource(ctx, id)
	return err
}

// PublicEditSource converts echo context to params.
func (w *ServerInterfaceWrapper) PublicEditSource(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicEditSource(ctx, id)
	return err
}

// PublicSourceIngestionManualRun converts echo context to params.
func (w *ServerInterfaceWrapper) PublicSourceIngestionManualRun(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicSourceIngestionManualRun(ctx, id)
	return err
}
...
func (w *ServerInterfaceWrapper) PublicGetUsers(ctx echo.Context) error {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params PublicGetUsersParams
	// ------------- Optional query parameter "page" -------------
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetUsers(ctx, params)
	return err
}

// PublicCreateUser converts echo context to params.
func (w *ServerInterfaceWrapper) PublicCreateUser(ctx echo.Context) error {
	var err error

	ctx.Set(JWTScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicCreateUser(ctx)
	return err
}

// PublicDeleteUser converts echo context to params.
func (w *ServerInterfaceWrapper) PublicDeleteUser(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicDeleteUser(ctx, id)
	return err
}

// PublicGetUser converts echo context to params.
func (w *ServerInterfaceWrapper) PublicGetUser(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicGetUser(ctx, id)
	return err
}

// PublicUpdateUser converts echo context to params.
func (w *ServerInterfaceWrapper) PublicUpdateUser(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicUpdateUser(ctx, id)
	return err
}

// PublicResetUserPassword converts echo context to params.
func (w *ServerInterfaceWrapper) PublicResetUserPassword(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PublicResetUserPassword(ctx, id)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/v1/assets/sync", wrapper.PublicSyncAssets)
	router.DELETE(baseURL+"/v1/assets/:name", wrapper.PublicDeleteWorkspace)
	router.GET(baseURL+"/v1/calendars", wrapper.PublicGetCalendars)
	router.POST(baseURL+"/v1/calendars", wrapper.PublicCreateCalendar)
	router.DELETE(baseURL+"/v1/calendars/:id", wrapper.PublicDeleteCalendar)
	router.GET(baseURL+"/v1/calendars/:id", wrapper.PublicGetCalendar)
	router.PATCH(baseURL+"/v1/calendars/:id", wrapper.PublicUpdateCalendar)
	router.GET(baseURL+"/v1/credentials", wrapper.PublicGetCredentials)
	router.POST(baseURL+"/v1/credentials", wrapper.PublicCreateCredential)
	router.DELETE(baseURL+"/v1/credentials/:name", wrapper.PublicDeleteCredential)
	router.GET(baseURL+"/v1/credentials/:name", wrapper.PublicGetCredential)
	router.PATCH(baseURL+"/v1/credentials/:name", wrapper.PublicUpdateCredential)
	router.POST(baseURL+"/v1/lineages/_create", wrapper.CreatePipelineDeclarativeLineage)
	router.POST(baseURL+"/v1/lineages/_remove", wrapper.RemovePipelineDeclarativeLineage)
	router.POST(baseURL+"/v1/metadata/dbt/:projectName/:target", wrapper.UploadDbtMetadataFiles)
	router.GET(baseURL+"/v1/rules", wrapper.GetAllRule)
	router.POST(baseURL+"/v1/rules/:id/_run", wrapper.SiffletRuleManualRun)
	router.GET(baseURL+"/v1/rules/:id/details", wrapper.GetSiffletRuleDetails)
	router.GET(baseURL+"/v1/rules/:id/info", wrapper.GetSiffletRuleInfo)
	router.GET(baseURL+"/v1/rules/:id/overview", wrapper.GetSiffletRuleOverview)
	router.GET(baseURL+"/v1/rules/:id/runs", wrapper.GetSiffletRuleRuns)
	router.GET(baseURL+"/v1/rules/:id/runs/:runId", wrapper.GetSiffletRuleRun)
	router.POST(baseURL+"/v1/sources", wrapper.PublicCreateSource)
	router.POST(baseURL+"/v1/sources/search", wrapper.PublicGetSources)
	router.POST(baseURL+"/v1/sources/test-connection", wrapper.TestSourceConnection)
	router.DELETE(baseURL+"/v1/sources/:id", wrapper.PublicDeleteSourceById)
	router.GET(baseURL+"/v1/sources/:id", wrapper.PublicGetSource)
	router.PATCH(baseURL+"/v1/sources/:id", wrapper.PublicEditSource)
	router.POST(baseURL+"/v1/sources/:id/run", wrapper.PublicSourceIngestionManualRun)
	router.GET(baseURL+"/v1/users", wrapper.PublicGetUsers)
	router.POST(baseURL+"/v1/users", wrapper.PublicCreateUser)
	router.DELETE(baseURL+"/v1/users/:id", wrapper.PublicDeleteUser)
	router.GET(baseURL+"/v1/users/:id", wrapper.PublicGetUser)
	router.PATCH(baseURL+"/v1/users/:id", wrapper.PublicUpdateUser)
	router.POST(baseURL+"/v1/users/:id/reset-password", wrapper.PublicResetUserPassword)
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+y9a3PbthIw/FcwPO9MTueVZTtOe1rPPB9kSbGVyJKqS3JyYo8DkZCEmiIYALSj5sl/",
	"fwYX3kRQJBXbuZRfGlfEZbHYGxaL3c+WTdY+8ZDHmXX62WL2Cq2h/LNl24ixKblF3oiSO+wg2uFEfIGu",
	"O1xYp+8/W/8fRQvr1PrXYTzKoR7iMNnpS+Oz5VPiI8oxkqN7cI3Ev3zjI+vUYpxib2l9+dIIfyHzv5DN",
	"rS/XmV8aVssVA3nLC0JuNUzp0W2KIEfO2cYwRSP82oFcgrAgdA25dWo5kKMDjtfIamQ7oU8cUQ+6Yk7j",
	"qNhJDRYE2DGN40LGL4mDF7gqBGvdK2dVORgNB/psIS9YW6fvrUm/1X5tNazLVq8v/pncTLuty4l13TDs",
	"BkUfA0yRIzqmUCAXrGfVHY1bFXCyhhwTb+RCLhZq3LA14tCBHIq/dxFVdrhL3VORWbTYQroygZYcKwOi",
	"j33kYg8NylJuw2pDF3kOpFO8RswlPDuoY6IA0+Y7iNkU+wJayT6B68K5i6xTTgNUtHFy0GsjgBy6ZPkS",
	"uzzi7i1OWmHXoUhOijlas6IdUmN1XbRGHk9tigUphZuYVcpT8McA0U1ZnK+gt0TGtSwoWReB/4oRb0Ac",
	"JIYS7d8Sest8aKNeOfZW85adgZPK428x84B4gl7aUqRFf/QWl5gx0aVhXZI7pP9pec7M1xQW/dFBLkqR",
	"xy7sdiCHDPEzitHCiGPBPowE1M7jk0aiydTMrKVlaS7BBNQzk8sWVyRBzQCWlnBiyOs8jMhOj6Alvw4P",
	"RmWaxEC8PtPKMpx8agav/LZQxAJXGRrRmrDHT57Hi8IeR0tEM5uVC+U58hDF9iMgf5cRUYjauLMRaMzb",
